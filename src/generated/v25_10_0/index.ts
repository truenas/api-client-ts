 ...
 * rather than an output. The series also carries the `virt.*` namespace and
 * `pool.dataset.encryption_algorithm_choices`, which no dump can reproduce: middleware deleted those models from every version
